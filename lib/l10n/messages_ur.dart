...
class SUr extends S {
  ...
  @override
  String get driver_register_profile_submitted_message => 'آپ کا پروفائل ایڈمن کی منظوری کے لیے جمع کرایا گیا ہے۔ آپ اپنی جمع کرانے کی صورتحال دیکھنے کے لیے بعد میں دوبارہ چیک کر سکتے ہیں۔';

  @override
  String get driver_registration_approved_demo_mode => 'عام طور پر، اس مرحلے پر منتظم کو ایڈمن پینل سے ڈرائیور کی جمع آوری کو منظور کرنے کی ضرورت ہوگی۔ تاہم، ڈیمو کی خاطر، آپ کا پروفائل اب خود بخود منظور ہو گیا ہے اور استعمال کے لیے تیار ہے۔';
  ...
  @override
  String get driver_registration_step_verify_number_title => 'نمبر کی تصدیق کریں۔';
  ...
  @override
  String get driver_register_step_documents_heading => 'مندرجہ بالا دستاویزات کی تصدیق کرنے کے لیے، ہمیں درج ذیل دستاویزات کو اپ لوڈ کرنے کی ضرورت ہے۔';
  ...
  @override
  String get trip_history_empty_state => 'ماضی کا کوئی آرڈر ریکارڈ نہیں کیا گیا ہے۔';
  ...
  @override
  String get status_offline_description => 'درخواستیں دیکھنے کے لیے آن لائن ہوں۔';

  @override
  String get status_online_description => 'سواری کی تلاش ہے۔';

  @override
  String get order_status_card_title_driver_accepted => 'آپ کے پہنچنے پر ٹیپ کرنے کے بعد سوار کو مطلع کر دیا جائے گا۔';
  ...
  @override
  String get navigation_dialog_title => 'نیویگیٹ کرنے کے لیے ایک ایپ منتخب کریں۔';
  ...
  @override
  String get order_payment_status_unpaid => 'سواری کی ادائیگی ابھی تک نہیں ہوئی ہے۔';
  ...
  @override
  String get navigation_title_destination_point => 'ڈراپ آف پوائنٹ پر نیویگیٹ کریں۔';
  ...
  @override
  String get invoice_dialog_body => 'آپ آن لائن ادائیگی کے بجائے نقد بھی وصول کر سکتے ہیں اگر آپ اور مصنف دونوں اس کے لیے تیار ہیں۔';
  ...
  @override
  String get add_credit_dialog_select_payment_method => 'ادائیگی کا طریقہ منتخب کریں:';
  ...
  @override
  String get issue_submit_body => 'آپ اپنی سواری سے متعلق کسی بھی مسئلے کی اطلاع دے سکتے ہیں۔ ہم ایک کال کے اندر اس مسئلے میں آپ کی مدد کریں گے۔';
  ...
  @override
  String get earnings_empty_state_body => 'اوپر مقرر کردہ معیار پر، ہم کوئی ریکارڈ نہیں ڈھونڈ سکتے۔';

  @override
  String get action_continue => 'جاری رہے';

  @override
  String get terms_and_condition_first_part => 'میں نے پڑھا ہے اور اس سے متفق ہوں۔';
  ...
  @override
  String get incomplete_registration_description => 'براہ کرم اپنا مکمل کریں۔\n رجسٹریشن جمع کرانے';

  @override
  String get pending_review_registration_description => 'آپ کی جمع آوری زیر غور ہے،\n صبر کے لیے شکریہ۔';

  @override
  String get hard_reject_registration => 'آپ کی جمع کرانے کو مکمل طور پر مسترد کر دیا گیا ہے!';
  ...
  @override
  String get logout_dialog_body => 'کیا آپ واقعی درخواست سے لاگ آؤٹ کرنا چاہتے ہیں؟';
  ...
  @override
  String get dialog_account_deletion_body => 'کیا آپ واقعی اپنا اکاؤنٹ حذف کرنا چاہتے ہیں؟ آپ اکاؤنٹ کو بحال کرنے کے لیے 30 دنوں کے اندر دوبارہ لاگ ان کر سکتے ہیں۔ اس مدت کے بعد، آپ کا ڈیٹا مکمل طور پر ہٹا دیا جاتا ہے، بشمول آپ کے باقی تمام کریڈٹس۔';
  ...
  @override
  String get register_number_subtitle => 'رجسٹریشن جاری رکھنے کے لیے ہم آپ کے نمبر پر ایک کوڈ بھیجیں گے۔';
  ...
  @override
  String get register_contact_details_title => 'اپنے رابطے کی تفصیلات درج کریں۔';

  @override
  String get register_payout_details_title => 'اپنی ادائیگی کی تفصیلات درج کریں۔';
  ...
  @override
  String get register_profile_photo_subtitle => 'اپ لوڈ کردہ تصویر میں آپ کا چہرہ پہچانا جانا چاہیے۔';
  ...
  @override
  String get register_upload_documents_subtitle => 'اپنی شناخت کی توثیق کرنے اور ضوابط کی تعمیل کرنے کے لیے ہمیں آپ سے نیچے دی گئی دستاویزات کو اپ لوڈ کرنے کی ضرورت ہوگی: \\n1-تصویر ID\\n2-ڈرائیور لائسنس\\n3-رائیڈ کی ملکیت کی دستاویز';

...
import 'package:sms_firebase/ride_options_sheet_view.dart';
import 'package:sms_firebase/rider_preferences_sheet_view.dart';
...
class OrderStatusCardView extends StatelessWidget {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (order.waitMinutes != null && order.waitMinutes! > 0)
                                      Text(
                                            "🕒 ${order.waitMinutes} min",
  ...
  String getFinishedButtonText(
    ...
    return destinationIndex == addresses.length - 1
        ...
        //ajuste: si el destinationIndex == 0 , que no sume los destino ya que es uno
        //15/01/2024
        : (destinationIndex == 0 ? 'Llegó al destino': S.of(context).actionArrivedToDestination(destinationIndex + 1));
  }
...
class ChatIconButton extends StatefulWidget {
  final Fragment$CurrentOrder order;
  const ChatIconButton({super.key, required this.order});

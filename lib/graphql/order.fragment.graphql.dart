...
import 'package:sms_firebase/graphql/scalars/connection_cursor.dart';
import 'package:sms_firebase/graphql/scalars/timestamp.dart';
  ...
  TRes call({
    ...
    Object? waitMinutes = _undefined,
      ...
      _then(Fragment$CurrentOrder(
        ...
        waitMinutes:
        waitMinutes == _undefined || waitMinutes == null

...
class Mutation$DeleteMedia {
  Mutation$DeleteMedia({required this.deleteMedia});

  factory Mutation$DeleteMedia.fromJson(Map<String, dynamic> json) {
    final l$deleteMedia = json['deleteMedia'];
    return Mutation$DeleteMedia(
        deleteMedia: Mutation$DeleteMedia$deleteMedia.fromJson(
            (l$deleteMedia as Map<String, dynamic>)));
  }

  final Mutation$DeleteMedia$deleteMedia deleteMedia;

  Map<String, dynamic> toJson() {
    final _resultData = <String, dynamic>{};
    final l$deleteMedia = deleteMedia;
    _resultData['deleteMedia'] = l$deleteMedia.toJson();
    return _resultData;
  }
  ...
  int get hashCode {
    final l$deleteMedia = deleteMedia;
    return Object.hashAll([l$deleteMedia]);
  }
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Mutation$DeleteMedia) || runtimeType != other.runtimeType) {
      return false;
    }
    final l$deleteMedia = deleteMedia;
    final lOther$deleteMedia = other.deleteMedia;
    if (l$deleteMedia != lOther$deleteMedia) {
      return false;
    }
    return true;
  }
...
extension UtilityExtension$Mutation$DeleteMedia on Mutation$DeleteMedia {
  CopyWith$Mutation$DeleteMedia<Mutation$DeleteMedia> get copyWith =>
      CopyWith$Mutation$DeleteMedia(
        this,
            (i) => i,
      );
}

abstract class CopyWith$Mutation$DeleteMedia<TRes> {
  factory CopyWith$Mutation$DeleteMedia(
      Mutation$DeleteMedia instance,
      TRes Function(Mutation$DeleteMedia) then,
      ) = _CopyWithImpl$Mutation$DeleteMedia;

  factory CopyWith$Mutation$DeleteMedia.stub(TRes res) =
  _CopyWithStubImpl$Mutation$DeleteMedia;

  TRes call({Mutation$DeleteMedia$deleteMedia? deleteMedia});
  CopyWith$Mutation$DeleteMedia$deleteMedia<TRes> get deleteMedia;
}

class _CopyWithImpl$Mutation$DeleteMedia<TRes>
    implements CopyWith$Mutation$DeleteMedia<TRes> {
  _CopyWithImpl$Mutation$DeleteMedia(
      this._instance,
      this._then,
      );

  final Mutation$DeleteMedia _instance;

  final TRes Function(Mutation$DeleteMedia) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({Object? deleteMedia = _undefined}) => _then(Mutation$DeleteMedia(
      deleteMedia: deleteMedia == _undefined || deleteMedia == null
          ? _instance.deleteMedia
          : (deleteMedia as Mutation$DeleteMedia$deleteMedia)));
  CopyWith$Mutation$DeleteMedia$deleteMedia<TRes> get deleteMedia {
    final local$deleteMedia = _instance.deleteMedia;
    return CopyWith$Mutation$DeleteMedia$deleteMedia(
        local$deleteMedia, (e) => call(deleteMedia: e));
  }
}

class _CopyWithStubImpl$Mutation$DeleteMedia<TRes>
    implements CopyWith$Mutation$DeleteMedia<TRes> {
  _CopyWithStubImpl$Mutation$DeleteMedia(this._res);

  TRes _res;

  call({Mutation$DeleteMedia$deleteMedia? deleteMedia}) => _res;
  CopyWith$Mutation$DeleteMedia$deleteMedia<TRes> get deleteMedia =>
      CopyWith$Mutation$DeleteMedia$deleteMedia.stub(_res);
}

const documentNodeMutationDeleteMedia = DocumentNode(definitions: [
  OperationDefinitionNode(
    type: OperationType.mutation,
    name: NameNode(value: 'DeleteMedia'),
    variableDefinitions: [],
    directives: [],
    selectionSet: SelectionSetNode(selections: [
      FieldNode(
...
Mutation$DeleteMedia _parserFn$Mutation$DeleteMedia(Map<String, dynamic> data) =>
    Mutation$DeleteMedia.fromJson(data);
typedef OnMutationCompleted$Mutation$DeleteMedia = FutureOr<void> Function(
    Map<String, dynamic>?,
    Mutation$DeleteMedia?,
    );

class Options$Mutation$DeleteMedia
    extends graphql.MutationOptions<Mutation$DeleteMedia> {
  Options$Mutation$DeleteMedia({
    String? operationName,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
    Object? optimisticResult,
    Mutation$DeleteMedia? typedOptimisticResult,
    graphql.Context? context,
    OnMutationCompleted$Mutation$DeleteMedia? onCompleted,
    graphql.OnMutationUpdate<Mutation$DeleteMedia>? update,
    graphql.OnError? onError,
  })  : onCompletedWithParsed = onCompleted,
        super(
        operationName: operationName,
        ...
        onCompleted: onCompleted == null
            ...
            : (data) => onCompleted(
          data,
          data == null ? null : _parserFn$Mutation$DeleteMedia(data),
        ),
        update: update,
        onError: onError,
        document: documentNodeMutationDeleteMedia,
        parserFn: _parserFn$Mutation$DeleteMedia,
      );

  final OnMutationCompleted$Mutation$DeleteMedia? onCompletedWithParsed;
...
class WatchOptions$Mutation$DeleteMedia
    extends graphql.WatchQueryOptions<Mutation$DeleteMedia> {
  WatchOptions$Mutation$DeleteMedia({
    String? operationName,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
...
extension ClientExtension$Mutation$DeleteMedia on graphql.GraphQLClient {
  Future<graphql.QueryResult<Mutation$DeleteMedia>> mutate$DeleteMedia(
      [Options$Mutation$DeleteMedia? options]) async =>
      await this.mutate(options ?? Options$Mutation$DeleteMedia());
  graphql.ObservableQuery<Mutation$DeleteMedia> watchMutation$DeleteMedia(
      [WatchOptions$Mutation$DeleteMedia? options]) =>
      this.watchMutation(options ?? WatchOptions$Mutation$DeleteMedia());
}

class Mutation$DeleteMedia$HookResult {
  Mutation$DeleteMedia$HookResult(
      this.runMutation,
      this.result,
      );

  final RunMutation$Mutation$DeleteMedia runMutation;

  final graphql.QueryResult<Mutation$DeleteMedia> result;
}

Mutation$DeleteMedia$HookResult useMutation$DeleteMedia(
    [WidgetOptions$Mutation$DeleteMedia? options]) {
  final result = graphql_flutter
      .useMutation(options ?? WidgetOptions$Mutation$DeleteMedia());
  return Mutation$DeleteMedia$HookResult(
        ({optimisticResult, typedOptimisticResult}) => result.runMutation(
      const {},
      optimisticResult: optimisticResult ?? typedOptimisticResult?.toJson(),
    ),
...
graphql.ObservableQuery<Mutation$DeleteMedia> useWatchMutation$DeleteMedia(
    [WatchOptions$Mutation$DeleteMedia? options]) =>
    graphql_flutter
        .useWatchMutation(options ?? WatchOptions$Mutation$DeleteMedia());

class WidgetOptions$Mutation$DeleteMedia
    extends graphql.MutationOptions<Mutation$DeleteMedia> {
  WidgetOptions$Mutation$DeleteMedia({
    String? operationName,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
...
typedef RunMutation$Mutation$DeleteMedia
= graphql.MultiSourceResult<Mutation$DeleteMedia> Function({
Object? optimisticResult,
Mutation$DeleteMedia? typedOptimisticResult,
});
typedef Builder$Mutation$DeleteMedia = widgets.Widget Function(
    RunMutation$Mutation$DeleteMedia,
    graphql.QueryResult<Mutation$DeleteMedia>?,
    );

class Mutation$DeleteMedia$Widget
    extends graphql_flutter.Mutation<Mutation$DeleteMedia> {
  Mutation$DeleteMedia$Widget({
    widgets.Key? key,
    WidgetOptions$Mutation$DeleteMedia? options,
    required Builder$Mutation$DeleteMedia builder,
  }) : super(
    key: key,
    options: options ?? WidgetOptions$Mutation$DeleteMedia(),
    builder: (
        run,
        result,
        ) =>
...
class Mutation$DeleteMedia$deleteMedia {
  Mutation$DeleteMedia$deleteMedia({required this.id});

  factory Mutation$DeleteMedia$deleteMedia.fromJson(Map<String, dynamic> json) {
    final l$id = json['id'];
    return Mutation$DeleteMedia$deleteMedia(id: (l$id as String));
  }
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Mutation$DeleteMedia$deleteMedia) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$id = id;
...
extension UtilityExtension$Mutation$DeleteMedia$deleteMedia
on Mutation$DeleteMedia$deleteMedia {
  CopyWith$Mutation$DeleteMedia$deleteMedia<Mutation$DeleteMedia$deleteMedia>
  get copyWith => CopyWith$Mutation$DeleteMedia$deleteMedia(
    this,
        (i) => i,
  );
}

abstract class CopyWith$Mutation$DeleteMedia$deleteMedia<TRes> {
  factory CopyWith$Mutation$DeleteMedia$deleteMedia(
      Mutation$DeleteMedia$deleteMedia instance,
      TRes Function(Mutation$DeleteMedia$deleteMedia) then,
      ) = _CopyWithImpl$Mutation$DeleteMedia$deleteMedia;

  factory CopyWith$Mutation$DeleteMedia$deleteMedia.stub(TRes res) =
  _CopyWithStubImpl$Mutation$DeleteMedia$deleteMedia;

  TRes call({String? id});
}

class _CopyWithImpl$Mutation$DeleteMedia$deleteMedia<TRes>
    implements CopyWith$Mutation$DeleteMedia$deleteMedia<TRes> {
  _CopyWithImpl$Mutation$DeleteMedia$deleteMedia(
      this._instance,
      this._then,
      );

  final Mutation$DeleteMedia$deleteMedia _instance;

  final TRes Function(Mutation$DeleteMedia$deleteMedia) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({Object? id = _undefined}) => _then(Mutation$DeleteMedia$deleteMedia(
      id: id == _undefined || id == null ? _instance.id : (id as String)));
}

class _CopyWithStubImpl$Mutation$DeleteMedia$deleteMedia<TRes>
    implements CopyWith$Mutation$DeleteMedia$deleteMedia<TRes> {
  _CopyWithStubImpl$Mutation$DeleteMedia$deleteMedia(this._res);

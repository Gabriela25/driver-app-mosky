...
class OrderInvoiceView extends StatelessWidget {
  ...
  const OrderInvoiceView(
      {required this.order, required this.onCashPaymentReceived, super.key});
          ...
          SizedBox(
            ...
            child: OutlinedButton(
                ...
                child: Text(
                  ...
                  style: TextStyle(color: Theme.of(context).primaryColor) //Theme.of(context).textTheme.titleMedium,
                )),
          )
        ],
      ),
